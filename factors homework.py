from tkinter import*
win=Tk()
win.title('Factors(write the number to have its factors)')
e=Entry(win,width=45,borderwidth=10)
...
button_clear=Button(win,text='clear',padx=40,pady=20,command=lambda:e.delete(0,END))
button_factor=Button(win,text='factor',padx=40,pady=20,command=lambda:factors())
...
button_factor.grid(row=4,column=2)
win.mainloop()
